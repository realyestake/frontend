        ...
        <div className="flex md:flex-row flex-col lg:mt-14 items-center">
          ...
          <div className="lg:ml-16">
            <Card color="transparent" shadow={false}>
              ...
              <form className="mt-4  mb-2 lg:w-80 max-w-screen-lg " onSubmit={handleSubmit}>
                ...
                <Button
                type="submit"
                  className="lg:text-[14px] text-[12px] mt-4 normal-case text-[#FFFFFF] rounded-[47px] bg-gradient-to-r from-[#2934FE] to-[#BF32EC]"
                  fullWidth
                >
                  Sign In
                </Button>
