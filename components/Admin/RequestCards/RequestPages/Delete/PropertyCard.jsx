    ...
    >
      ...
      >
        ...
        <Link href={`/properties/${_id}`}>
          ...
          <Link href={`/properties/${_id}`}>
          <Button className=" capitalize Outfit text-[16px] rounded-[47px] hover:bg-white hover:text-[#F64070] bg-transparent font-normal leading-[17.64px] border border-white px-10 py-[10px]">View Property</Button>
            </Link>
        </CardFooter>
      </Card>
    );
