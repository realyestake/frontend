...
export function TransferPropertyCard({
    ...
    console.log("Transfer Data", newOwner);
    ...
    const handleRejectBtn = () => {
        ...
        try {
            const response = axios.put(
                `https://api.realyestake.com/api/requests/transfer/${transferData._id}/decline`,
                {
    ...
    const handleApproveBtn = () => {
        ...
        try {
            const response = axios.put(
                `https://api.realyestake.com/api/requests/transfer/${transferData._id}/approve`,
