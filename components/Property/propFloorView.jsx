          ...
          <div className="">
            {data && data.length>0 ?  (
              <Image
                ...
                width={2299}
                height={2000}
                className={`object-cover items-center lg:h-[600px] justify-center rounded-[16px] transition-all duration-300 `}
              />
            ):(
              <div className="text-center text-gray-700">
                <Typography variant="paragraph">No Floor Images Available</Typography>
              </div>
            )}
          </div>
        </div>
